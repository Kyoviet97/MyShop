...
package com.mylibrary.ui.borderimg;
...
public class RoundedImageView extends AppCompatImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            drawableBackground = a.getDrawable(R.styleable.RoundedImageView_riv_drawableBackgroundCompat);
        } else {
            final int drawableBackgroundId = a.getResourceId(R.styleable.RoundedImageView_riv_drawableBackgroundCompat, -1);
