...
public class CustomInputText extends AppCompatEditText {
    ...
    public CustomInputText(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CustomInputText, 0, 0);
//        String fontName = a.getString(R.styleable.CustomInputText_font_edt_custom);
//        if (fontName != null) {
//            Typeface typeface = ResourcesCompat.getFont(context, fontName);
